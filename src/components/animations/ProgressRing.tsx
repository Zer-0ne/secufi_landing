...
const ProgressRing = () => {
  ...
  return (
    <div
      className={`fixed bottom-4 right-4 sm:bottom-8 sm:right-8 z-50 transition-all duration-1000 ${
    ...
    >
      <div className="relative" ref={containerRef}>
        ...
        <div 
          className={`relative bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border-2 border-teal-200/50 hover:border-teal-300/70 transition-all duration-500 hover:shadow-teal-200/50 hover:shadow-3xl cursor-pointer ${
            shouldShowExpanded 
